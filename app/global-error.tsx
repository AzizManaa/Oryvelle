...
export default function GlobalError({
  ...
  return (
    <html lang="en">
      <body>
        <main className="relative min-h-screen overflow-hidden bg-[#080510] px-5 py-24 text-[#EDEAF5] sm:px-8">
          ...
          <div className="relative mx-auto grid min-h-[calc(100vh-12rem)] w-full max-w-6xl items-center gap-12 lg:grid-cols-[minmax(320px,1fr)_minmax(0,0.85fr)]">
            ...
            >
              ...
              <div className="absolute inset-[14%] rounded-full border border-[#FFB87A]/20" />
              <div className="absolute inset-[28%] rounded-full border border-[#00E0C7]/20" />

              <div className="absolute top-1/2 left-1/2 h-32 w-32 -translate-x-1/2 -translate-y-1/2 rounded-full border border-[#FFB87A]/45 bg-[radial-gradient(circle,rgba(255,184,122,0.24),rgba(255,184,122,0.05)_58%,transparent_72%)] shadow-[0_0_70px_rgba(255,184,122,0.26)]" />
              <div className="absolute top-1/2 left-1/2 h-3 w-3 -translate-x-1/2 -translate-y-1/2 rounded-full bg-[#EDEAF5] shadow-[0_0_24px_rgba(237,234,245,0.55)]" />

              <div className="absolute top-[18%] right-[18%] rounded-full border border-[#00E0C7]/25 px-3 py-1 text-[10px] font-medium tracking-[0.22em] text-[#00E0C7] uppercase">
                retry
              </div>

              <div className="absolute right-[10%] bottom-[18%] left-[10%] rounded-[8px] border border-white/[0.1] bg-[#080510]/85 p-4">
                <div className="mb-4 flex items-center justify-between gap-4">
                  ...
                  <div className="h-2.5 w-2.5 rounded-full bg-[#FFB87A] shadow-[0_0_18px_rgba(255,184,122,0.7)]" />
                </div>
